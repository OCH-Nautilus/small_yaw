...
int next_heat_change()
{
    ...
    heat_recover = USART_Rx_data.shooter_barrel_cooling_value / 10;  // 除10代表0.1秒的冷却
...
{
    int heat_limit = USART_Rx_data.shooter_barrel_heat_limit; // 热量上限
    int heat = USART_Rx_data.shooter_17mm_1_barrel_heat;   // 当前热量
