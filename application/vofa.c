...
//Vofa_Send_Data8(Vision_Rx.yaw,INS.Yaw,-Vision_Rx.pitch,INS.Pitch,mode.trigger_state,rc_ctrl.mouse .KEY_L_State,0,IF_FIRE());
		...
		//Vofa_Send_Data8(GIMBAL.yaw_target,INS.Yaw,USART_Rx_data.big_yaw_target,USART_Rx_data.ins_big_yaw,USART_Rx_data.real_power,small_yaw._pos,0,0);
		Vofa_Send_Data8(USART_Rx_data.initial_speed,USART_Rx_data.real_power,USART_Rx_data.cap_v,0,0,0,0,0);
		vTaskDelay(10);
  }
}
